...
async function main() {
  ...
  const imageUrl = "https://dbukjj6eu5tsf.cloudfront.net/sidearm.sites/fsdb.sidearmsports.com/images/logos/site/site.png"; // Only use image if explicitly provided
